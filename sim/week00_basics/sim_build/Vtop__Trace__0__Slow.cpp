...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+4,0,"q",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
...
VL_ATTR_COLD void Vtop___024root__trace_full_0_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+5,(vlSelf->counter__DOT__clk));
    bufp->fullBit(oldp+6,(vlSelf->counter__DOT__rstn));
    bufp->fullBit(oldp+7,(vlSelf->counter__DOT__en));
    bufp->fullCData(oldp+8,(vlSelf->counter__DOT__q),8);
}
